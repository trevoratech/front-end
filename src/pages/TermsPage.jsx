        ...
        <div className={styles.body}>
          <div className={styles.bodyInner}>
            ...
            <ul>
              ...
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) refers to Trevoratech Innovations LLC.</li>
            ...
            <p>Your access to and use of the Service is also subject to Our <Link to="/privacy">Privacy Policy</Link>, which describes how We collect, use, and disclose personal information. Please read Our Privacy Policy carefully before using Our Service.</p>
            ...
            <p>You acknowledge and agree that the Company shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with Your access to or use of any Third-Party Social Media Service. Your use of any Third-Party Social Media Service is governed by that service's own terms and privacy policies.</p>
